 ...
 */
class Phone extends \AppBundle\Entity\Phone implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Phone' . "\0" . 'model', '' . "\0" . 'AppBundle\\Entity\\Phone' . "\0" . 'memory', '' . "\0" . 'AppBundle\\Entity\\Phone' . "\0" . 'color', 'id', 'brand', 'price', 'description'];
        }
    ...
    public function setMemory($memory)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setMemory', [$memory]);

        return parent::setMemory($memory);
    }
    ...
    public function getMemory()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getMemory', []);
